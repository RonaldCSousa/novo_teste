...
from streamlit_folium import folium_static  # Importando folium_static para renderizar o mapa
import requests
...
folium_static(mapa_brasil, width=800, height=600)  # Usando folium_static para exibir o mapa
